...
# ================= CONFIGURATION =================
INPUT_DIR =  '..\\..\\data\\\\DB_Vein\\'  # Root folder with structure: Directory/Category/images/
TRAIN_TEST_DIR = "..\\..\\data\\split_dataset"    # Output for train/test splits
